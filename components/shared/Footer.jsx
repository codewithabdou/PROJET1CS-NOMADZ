...
const Footer = () => {
  return (
    <div className="bg-[#F4EAE5]">
        ...
        <div className="w-full xl:w-1/2 flex flex-row justify-evenly   ">
          <div className=" flex w-1/2   flex-col items-start gap-y-2 justify-center px-4">
            ...
            <div className="flex w-full space-x-4">
              ...
              <a
                href="https://www.linkedin.com/in/khaled-abderrahm%C3%A8ne-habouche-82605626b/"
                target="_blank"
              >
          ...
          <div className="space-y-3   w-1/2 md:pl-16 px-8 pt-4">
            ...
            <button
              type="button"
              className=" border font-normal xl:w-36 w-32 border-[#FA7436] bg-[#FA7436] py-1.5 xl:px-8 px-6 text-white transition-all hover:bg-white hover:-translate-y-1 hover:translate-x-1 hover:text-[#FA7436] text-center text-sm  flex items-center justify-center"
            >
              Get Acces
            </button>
          </div>
        ...
        <div className=" xl:space-x-4 xl:w-1/2 w-full justify-around flex flex-row">
          <div className="space-y-2 pt-4 ">
            ...
            <ul className="space-y-1">
              <li className="text-xs text-gray-700 relative after:absolute after:left-0 after:bottom-0 hover:text-black duration-300 after:w-full after:transition-all after:duration-300 after:scale-x-0 after:bg-black after:h-[1px] hover:after:scale-x-100 transition-all cursor-pointer w-fit">
                Feautures
              </li>
              <li className="text-xs text-gray-700 relative after:absolute after:left-0 after:bottom-0 hover:text-black duration-300 after:w-full after:transition-all after:duration-300 after:scale-x-0 after:bg-black after:h-[1px] hover:after:scale-x-100 transition-all cursor-pointer w-fit">
                FAQ's
      ...
      <p className="text-xs text-gray-700 py-2 flex-center w-full ">
        ITouch - NomaDz © 2023 All Right Reserved
      </p>
    </div>
  );
};
